...
const Login = () => {
  ...
  return (
    <main
      className={`flex min-h-screen bg-[#131319] flex-col items-center overflow-hidden ${inter.className}`}
    >
      <svg
        className="mt-20"
        width="40"
      ...
      <div className="w-1/3 mt-4 bg-[#27292D] flex flex-col p-8 rounded-md shadow-lg">
        {component === "login" ? (
